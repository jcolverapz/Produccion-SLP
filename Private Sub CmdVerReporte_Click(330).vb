...
Hoja.Range("A5:AL5").Font.Size = 12
Hoja.Range("A5:AL5").Font.Bold = True


Hoja.Range("A4:AL5").Select
Hoja.Range("A4:AL4").Font.Name = "Times New Roman"
...
Hoja.Range("A4:AL4").Font.Bold = True
Hoja.Range("A5:AL5").Font.Bold = True
...
'Linea 20
Hoja.Range("G4:J4").Select
Hoja.Range("G4:J4").HorizontalAlignment = xlCenter
Hoja.Range("G4:J4").MergeCells = True

''Linea 40
Hoja.Range("K4:N4").Select
Hoja.Range("K4:N4").HorizontalAlignment = xlCenter
Hoja.Range("K4:N4").MergeCells = True

''Linea 40 CNC2
Hoja.Range("O4:R4").Select
Hoja.Range("O4:R4").HorizontalAlignment = xlCenter
Hoja.Range("O4:R4").MergeCells = True

'Linea 40 WaterJet
Hoja.Range("S4:V4").Select
Hoja.Range("S4:V4").HorizontalAlignment = xlCenter
Hoja.Range("S4:V4").MergeCells = True

'Linea 50
Hoja.Range("W4:Z4").Select
Hoja.Range("W4:Z4").HorizontalAlignment = xlCenter
Hoja.Range("W4:Z4").MergeCells = True
